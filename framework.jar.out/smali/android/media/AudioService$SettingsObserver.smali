...
.method public onChange(Z)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$6700(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    #getter for: Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v4}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$3600(Landroid/media/AudioService;)Z
    ...
    invoke-static {v4, v0}, Landroid/media/AudioService;->access$6802(Landroid/media/AudioService;I)I
    ...
    invoke-static {v4, v5, v6}, Landroid/media/AudioService;->access$5400(Landroid/media/AudioService;IZ)V
    ...
    #getter for: Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v5}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v4, v1}, Landroid/media/AudioService;->access$6902(Landroid/media/AudioService;Z)Z
