...
.method public constructor <init>(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[II)V
    ...
    invoke-direct {v0, p0}, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter$1;-><init>(Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;)V

    iput-object v0, p0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->showContextMenu:Landroid/view/View$OnClickListener;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 58
    new-instance v22, Lcom/andrew/apollo/views/ViewHolderList;
    ...
    .line 59
    .local v22, viewholder:Lcom/andrew/apollo/views/ViewHolderList;
    ...
    iput-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->holderReference:Ljava/lang/ref/WeakReference;

    .line 60
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->holderReference:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mCursor:Landroid/database/Cursor;
    ...
    sget v4, Lcom/andrew/apollo/list/fragments/ArtistAlbumsFragment;->mArtistNameIndex:I
    ...
    sget v4, Lcom/andrew/apollo/list/fragments/ArtistAlbumsFragment;->mSongCountIndex:I
    ...
    .line 78
    .local v20, songs_plural:I
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3, v4, v0, v5}, Lcom/andrew/apollo/utils/MusicUtils;->makeAlbumsLabel(Landroid/content/Context;IIZ)Ljava/lang/String;

    move-result-object v19

    .line 79
    .local v19, numSongs:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    iget-object v4, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->showContextMenu:Landroid/view/View$OnClickListener;
    ...
    sget v4, Lcom/andrew/apollo/list/fragments/ArtistAlbumsFragment;->mAlbumIdIndex:I
    ...
    iput-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mPeakOneAnimation:Landroid/graphics/drawable/AnimationDrawable;
    ...
    iput-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mPeakTwoAnimation:Landroid/graphics/drawable/AnimationDrawable;
    ...
    iget-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mPeakOneAnimation:Landroid/graphics/drawable/AnimationDrawable;
    ...
    iget-object v3, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mPeakTwoAnimation:Landroid/graphics/drawable/AnimationDrawable;
    ...
    .end local v19           #numSongs:Ljava/lang/String;
    .end local v20           #songs_plural:I
    .end local v22           #viewholder:Lcom/andrew/apollo/views/ViewHolderList;
    :cond_0
    invoke-virtual/range {p2 .. p2}, Landroid/view/View;->getTag()Ljava/lang/Object;

    move-result-object v22

    check-cast v22, Lcom/andrew/apollo/views/ViewHolderList;

    .restart local v22       #viewholder:Lcom/andrew/apollo/views/ViewHolderList;
    goto/16 :goto_0
    ...
    .restart local v19       #numSongs:Ljava/lang/String;
    .restart local v20       #songs_plural:I
    :cond_1
    const-string v3, "albumimage"

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v4, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->holderReference:Ljava/lang/ref/WeakReference;
    ...
    iget-object v7, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v6, v0, Lcom/andrew/apollo/adapters/ArtistAlbumAdapter;->holderReference:Ljava/lang/ref/WeakReference;
